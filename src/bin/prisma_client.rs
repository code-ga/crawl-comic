...
pub mod comic {
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(|(id, name, url, status, mut _params)| {
                    _params.extend([
                        id::set(id),
                        name::set(name),
                        url::set(url),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (id, name, url, status, mut _params): (String, String, String, String, Vec<SetParam>),
...
pub mod chapter {
    ...
    pub fn create(
        ...
        (id, name, url, comic, created_date, _params)
    }
    pub fn create_unchecked(
        id: String,
        name: String,
        ...
        (id, name, url, comic_id, created_date, _params)
    }
    #[macro_export]
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(|(id, name, url, comic_id, created_date, mut _params)| {
                    _params.extend([
                        id::set(id),
                        name::set(name),
                        url::set(url),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (id, name, url, comic, created_date, mut _params): (
                String,
                String,
                String,
                super::comic::UniqueWhereParam,
