...
pub mod urls {
    ...
    pub mod comic_id {
        ...
        pub fn equals(value: Option<String>) -> WhereParam {
            WhereParam::ComicId(_prisma::read_filters::StringNullableFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::StringNullableFilter,
            ComicId,
    ...
    #[macro_export]
    macro_rules ! _include_urls { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: urls :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: urls :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: urls :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: urls :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: urls :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: urls :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: urls :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: urls :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub url : String , pub id : String , pub fetched : bool , pub fetching : bool , pub comic_id : Option < String > , pub created_date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , $ (pub $ field : crate :: prisma :: urls :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (url) , stringify ! (id) , stringify ! (fetched) , stringify ! (fetching) , stringify ! (comic_id) , stringify ! (created_date)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: urls :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: urls :: url :: NAME , & self . url) ? ; state . serialize_field (crate :: prisma :: urls :: id :: NAME , & self . id) ? ; state . serialize_field (crate :: prisma :: urls :: fetched :: NAME , & self . fetched) ? ; state . serialize_field (crate :: prisma :: urls :: fetching :: NAME , & self . fetching) ? ; state . serialize_field (crate :: prisma :: urls :: comic_id :: NAME , & self . comic_id) ? ; state . serialize_field (crate :: prisma :: urls :: created_date :: NAME , & self . created_date) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , url , id , fetched , fetching , comic_id , created_date } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: urls :: $ field :: NAME) , + , crate :: prisma :: urls :: url :: NAME , crate :: prisma :: urls :: id :: NAME , crate :: prisma :: urls :: fetched :: NAME , crate :: prisma :: urls :: fetching :: NAME , crate :: prisma :: urls :: comic_id :: NAME , crate :: prisma :: urls :: created_date :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: urls :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: urls :: url :: NAME => Ok (Field :: url) , crate :: prisma :: urls :: id :: NAME => Ok (Field :: id) , crate :: prisma :: urls :: fetched :: NAME => Ok (Field :: fetched) , crate :: prisma :: urls :: fetching :: NAME => Ok (Field :: fetching) , crate :: prisma :: urls :: comic_id :: NAME => Ok (Field :: comic_id) , crate :: prisma :: urls :: created_date :: NAME => Ok (Field :: created_date) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut url = None ; let mut id = None ; let mut fetched = None ; let mut fetching = None ; let mut comic_id = None ; let mut created_date = None ; while let Some (key) = map . next_key () ? { match key { Field :: url => { if url . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: url :: NAME)) ; } url = Some (map . next_value () ?) ; } Field :: id => { if id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: id :: NAME)) ; } id = Some (map . next_value () ?) ; } Field :: fetched => { if fetched . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: fetched :: NAME)) ; } fetched = Some (map . next_value () ?) ; } Field :: fetching => { if fetching . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: fetching :: NAME)) ; } fetching = Some (map . next_value () ?) ; } Field :: comic_id => { if comic_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: comic_id :: NAME)) ; } comic_id = Some (map . next_value () ?) ; } Field :: created_date => { if created_date . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: created_date :: NAME)) ; } created_date = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: urls :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: $ field :: NAME)) ? ;) * let url = url . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: url :: NAME)) ? ; let id = id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: id :: NAME)) ? ; let fetched = fetched . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: fetched :: NAME)) ? ; let fetching = fetching . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: fetching :: NAME)) ? ; let comic_id = comic_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: comic_id :: NAME)) ? ; let created_date = created_date . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: urls :: created_date :: NAME)) ? ; Ok (Data { url , id , fetched , fetching , comic_id , created_date , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["url" , "id" , "fetched" , "fetching" , "comicId" , "createdDate"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: urls :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "Urls" , available relations are "")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: urls :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; url) => { "url" } ; (@ field_serde_name ; id) => { "id" } ; (@ field_serde_name ; fetched) => { "fetched" } ; (@ field_serde_name ; fetching) => { "fetching" } ; (@ field_serde_name ; comic_id) => { "comicId" } ; (@ field_serde_name ; created_date) => { "createdDate" } ; }
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_urls { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: urls struct $ struct_name { # [serde (rename = "url")] pub url : String , # [serde (rename = "id")] pub id : String , # [serde (rename = "fetched")] pub fetched : bool , # [serde (rename = "fetching")] pub fetching : bool , # [serde (rename = "comicId")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub comic_id : Option < String > , # [serde (rename = "createdDate")] pub created_date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > } [$ ($ scalar_field) , +] } } ; }
    ...
    pub enum WhereParam {
        ...
        ComicId(_prisma::read_filters::StringNullableFilter),
        CreatedDate(_prisma::read_filters::DateTimeFilter),
    }
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
