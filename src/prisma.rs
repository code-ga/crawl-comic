...
pub mod chapter {
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (name, url, comic_id, created_date, mut _params): (
                String,
                String,
                String,
                String,
